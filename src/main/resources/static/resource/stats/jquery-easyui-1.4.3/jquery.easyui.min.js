...
if (!_4f.realPosition) {
	if ($(e.data.target).css("top") != undefined && $(e.data.target).css("top") != "") {
		_54.top = $(e.data.target).css("top");
	} else {
		_54.top = 0;
	}
	
	if ($(e.data.target).css("left") != undefined && $(e.data.target).css("left") != "") {
		_54.left = $(e.data.target).css("left");
	} else {
		_54.left = 0;
	}
}
...
$.fn.draggable.defaults={realPosition:true,proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,delay:100,onBeforeDrag:function(e){
